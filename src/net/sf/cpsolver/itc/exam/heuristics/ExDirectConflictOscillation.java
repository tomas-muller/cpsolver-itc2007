 ...
 */
public class ExDirectConflictOscillation extends ItcParameterWeightOscillation {

    /** Constructor */
    public ExDirectConflictOscillation(Solver solver, DataProperties properties) {
