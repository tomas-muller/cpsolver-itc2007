...
/**
 * Oscillation of weight of direct student conflicts. It starts at one 
 ...
 * <br><br>
 * Direct conflicts are not allowed by default. To allow direct conflicts,
 * set Exam.AllowDirectConflict parameter to true.
 ...
 */
public class ExDirectConflictOscillation extends ItcParameterWeightOscillation<ExExam, ExPlacement> {

    /** Constructor */
    public ExDirectConflictOscillation(Solver<ExExam, ExPlacement> solver, DataProperties properties) {
    ...
    public void changeWeight(double weight) {
        ((ExModel)getModel()).setDirectConflictWeight((int)Math.round(weight));
    }
}
