 ...
 */
public class TimNoRoomWeightOscillation extends ItcParameterWeightOscillation {
    /** Constructor */
    public TimNoRoomWeightOscillation(Solver solver, DataProperties properties) {
