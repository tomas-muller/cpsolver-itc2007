 ...
 */
public class TimPrecedenceWeightOscillation extends ItcParameterWeightOscillation<TimEvent, TimLocation> {
    /** Constructor */
    public TimPrecedenceWeightOscillation(Solver<TimEvent, TimLocation> solver, DataProperties properties) {
